...
namespace NiceHashMiner.Miners {
    ...
    public static class MinersManager {
        ...
        public static List<MiningDevice> GetMiningDevices()
        {
            return CurMiningSession.GetMiningDevices();
        }

        public static Dictionary<string, GroupMiner> GetGroupMiners()
        {
            return CurMiningSession.GetGroupMiners();
        }
